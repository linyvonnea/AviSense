...
In the segmented processing approach, the same MFCC, spectral, and temporal features were used as in the baseline. However, to better capture local acoustic characteristics, they were extracted independently for each segment to preserve local temporal structure. The extracted time-domain features includes:
\begin{itemize}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.70\textwidth]{figures/segment_recording_level_confusion_matrix.png}
