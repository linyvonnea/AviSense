...
\begin{itemize}
  \item Spectral features: Describe the frequency characteristics of the bird and understand the shape and distribution of the sound’s spectrum.
  \item Temporal features: Describe the intensity of the sound wave.
\end{itemize}
}
